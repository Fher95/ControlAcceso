...
import { ReporteAsistenciaComponent } from 'app/entities/reporte-asistencia/reporte-asistencia.component';
...
describe('Component Tests', () => {
  describe('ReporteAsistencia Management Component', () => {
    let comp: ReporteAsistenciaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReporteAsistenciaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ReporteAsistencia(123)],
            headers
          })
        )
      );
      ...
      expect(comp.reporteAsistencias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
