...
describe('Service Tests', () => {
  describe('Turno Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Turno(0, TipoTurno.Laboral, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, 0, 'AAAAAAA', Estado.Activo);
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            umbralInicio: currentDate.format(DATE_TIME_FORMAT)
          },
          elemDefault
        );
        service
