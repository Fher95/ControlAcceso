...
import { CentroCostoComponent } from 'app/entities/centro-costo/centro-costo.component';
...
describe('Component Tests', () => {
  describe('CentroCosto Management Component', () => {
    let comp: CentroCostoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CentroCostoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.centroCostos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
