...
describe('Service Tests', () => {
  describe('Antecedentes Service', () => {
    let injector: TestBed;
    let service: AntecedentesService;
    let httpMock: HttpTestingController;
    let elemDefault: IAntecedentes;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Antecedentes', () => {
      ...
      it('should update a Antecedentes', () => {
        const returnedFromService = Object.assign(
          {
            tipo: 'BBBBBB',
            soporte: 'BBBBBB'
      ...
      it('should return a list of Antecedentes', () => {
        const returnedFromService = Object.assign(
          {
            tipo: 'BBBBBB',
            soporte: 'BBBBBB'
      ...
      it('should delete a Antecedentes', () => {
