...
import { AntecedentesComponent } from 'app/entities/antecedentes/antecedentes.component';
...
describe('Component Tests', () => {
  describe('Antecedentes Management Component', () => {
    let comp: AntecedentesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AntecedentesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.antecedentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
