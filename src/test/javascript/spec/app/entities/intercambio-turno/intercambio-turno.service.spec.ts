...
describe('Service Tests', () => {
  describe('IntercambioTurno Service', () => {
    let injector: TestBed;
    let service: IntercambioTurnoService;
    let httpMock: HttpTestingController;
    let elemDefault: IIntercambioTurno;
    let expectedResult;
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(IntercambioTurnoService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a IntercambioTurno', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fecha: currentDate.format(DATE_TIME_FORMAT),
        ...
        service
          .create(new IntercambioTurno(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a IntercambioTurno', () => {
        const returnedFromService = Object.assign(
          {
            fecha: currentDate.format(DATE_TIME_FORMAT),
            fechaFin: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of IntercambioTurno', () => {
        const returnedFromService = Object.assign(
          {
            fecha: currentDate.format(DATE_TIME_FORMAT),
            fechaFin: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a IntercambioTurno', () => {
