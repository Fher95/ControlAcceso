...
public interface AsignacionTurnoRepository extends JpaRepository<AsignacionTurno, Long> {
        ...
        @Query(value = "select distinct asignacionTurno from AsignacionTurno asignacionTurno left join fetch asignacionTurno.colaboradors", countQuery = "select count(distinct asignacionTurno) from AsignacionTurno asignacionTurno")
        ...
        /**
         * Esta consulta devuelve una lista de turnos Actuales, considerando que turnos
         * actuales son aquellos que no tienen una fechaFin
         *
        ...
        Page<AsignacionTurno> findAllAsignacionesActuales2(Pageable pageable);
        ...
        /**
         * Devuelve todos las asignaciones de turnos actuales del colaborador con el id
         * dado
         * 
         * @param id
         * @return
