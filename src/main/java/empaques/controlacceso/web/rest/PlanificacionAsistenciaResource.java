...
/**
 * REST controller for managing {@link empaques.controlacceso.domain.PlanificacionAsistencia}.
 */
@RestController
@RequestMapping("/api")
public class PlanificacionAsistenciaResource {
    ...
    /**
     * {@code POST  /planificacion-asistencias} : Create a new planificacionAsistencia.
     *
     * @param planificacionAsistencia the planificacionAsistencia to create.
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new planificacionAsistencia, or with status {@code 400 (Bad Request)} if the planificacionAsistencia has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/planificacion-asistencias")
    public ResponseEntity<PlanificacionAsistencia> createPlanificacionAsistencia(@RequestBody PlanificacionAsistencia planificacionAsistencia) throws URISyntaxException {
        log.debug("REST request to save PlanificacionAsistencia : {}", planificacionAsistencia);
        if (planificacionAsistencia.getId() != null) {
            throw new BadRequestAlertException("A new planificacionAsistencia cannot already have an ID", ENTITY_NAME, "idexists");
        }
        PlanificacionAsistencia result = planificacionAsistenciaRepository.save(planificacionAsistencia);
        return ResponseEntity.created(new URI("/api/planificacion-asistencias/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /planificacion-asistencias} : Updates an existing planificacionAsistencia.
     *
     * @param planificacionAsistencia the planificacionAsistencia to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated planificacionAsistencia,
     * or with status {@code 400 (Bad Request)} if the planificacionAsistencia is not valid,
     * or with status {@code 500 (Internal Server Error)} if the planificacionAsistencia couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/planificacion-asistencias")
    public ResponseEntity<PlanificacionAsistencia> updatePlanificacionAsistencia(@RequestBody PlanificacionAsistencia planificacionAsistencia) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, planificacionAsistencia.getId().toString()))
            .body(result);
    }

    /**
     * {@code GET  /planificacion-asistencias} : get all the planificacionAsistencias.
     *

     * @param pageable the pagination information.

     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of planificacionAsistencias in body.
     */
    ...
    /**
     * {@code GET  /planificacion-asistencias/:id} : get the "id" planificacionAsistencia.
     *
     * @param id the id of the planificacionAsistencia to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the planificacionAsistencia, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code DELETE  /planificacion-asistencias/:id} : delete the "id" planificacionAsistencia.
     *
