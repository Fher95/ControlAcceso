...
export class ColaboradorUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    nombre2: ['', [Validators.pattern('[a-zñA-ZÑáéíóúÁÉÍÓÚ ]*')]],
    apellido1: [null, [Validators.required, Validators.pattern('[a-zñA-ZÑáéíóúÁÉÍÓÚ ]*')]],
    apellido2: ['', [Validators.pattern('[a-zñA-ZÑáéíóúÁÉÍÓÚ ]*')]],
    tipoDocumento: [],
  ...
  updateForm(colaborador: IColaborador) {
    this.editForm.patchValue({
      ...
      nombre2: colaborador.nombre2 !== null ? colaborador.nombre2 : '',
      apellido1: colaborador.apellido1,
      apellido2: colaborador.apellido2 !== null ? colaborador.apellido2 : '',
  ...
  private createFromForm(): IColaborador {
    return {
      ...
      nombre2: this.editForm.get(['nombre2']).value != null ? this.editForm.get(['nombre2']).value : '',
      apellido1: this.editForm.get(['apellido1']).value,
      apellido2: this.editForm.get(['apellido2']).value != null ? this.editForm.get(['apellido2']).value : '',
